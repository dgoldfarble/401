	...
	, TOP__v                         (Verilated::catName(topp->name(),"v"))
{
	...
	__Vscope_v.varInsert(__Vfinal,"Instr1_IDREN", &(TOP__v.Instr1_IDREN), VLVT_UINT32,VLVD_NODIR|VLVF_PUB_RW,1 ,31,0);
	...
	__Vscope_v.varInsert(__Vfinal,"Reg_RF", &(TOP__v.Reg_RF), VLVT_UINT32,VLVD_NODIR|VLVF_PUB_RW,2 ,31,0 ,63,0);
	...
	__Vscope_v.varInsert(__Vfinal,"isRegWrInstr_IDREN", &(TOP__v.isRegWrInstr_IDREN), VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,1 ,1,0);
	...
	__Vscope_v.varInsert(__Vfinal,"renrat", &(TOP__v.renrat), VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,2 ,5,0 ,31,0);
	__Vscope_v.varInsert(__Vfinal,"retrat", &(TOP__v.retrat), VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,2 ,5,0 ,31,0);
	...
	__Vscope_v.varInsert(__Vfinal,"wWrRegID_IDREN", &(TOP__v.wWrRegID_IDREN), VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,1 ,4,0);
